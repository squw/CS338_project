...
for i in range(len(sql_paths)): 
    ...
    # Modify the full path to windows readable path
    escaped_file_path = full_file_path.replace("\\", "\\\\")
    modified_sql_load = sql_load.replace(place_holder, escaped_file_path)
